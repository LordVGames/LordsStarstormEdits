...
internal static class ErraticGadget
{
    ...
    {
        switch(ConfigOptions.ItemChanges.ErraticGadget.Value)
        {
            case ConfigOptions.ItemChanges.ErraticGadgetEditType.None:
                return;
            case ConfigOptions.ItemChanges.ErraticGadgetEditType.DamageMultAndOnHitProc:
                ...
                break;
            case ConfigOptions.ItemChanges.ErraticGadgetEditType.OnlyDamageMult:
                Mdh.SS2.Items.ErraticGadget.LightningOrb_OnArrival.ILHook(SkipDoublingProc);
                Mdh.SS2.Items.ErraticGadget.LightningStrikeOrb_OnArrival.ControlFlowPrefix(LightningStrikeOrb_JustMoreDamage);
                Mdh.SS2.Items.ErraticGadget.SimpleLightningStrikeOrb_OnArrival.ControlFlowPrefix(SimpleLightningStrikeOrb_JustMoreDamage);
                //Mdh.SS2.Items.ErraticGadget.VoidLightningOrb_Begin.ControlFlowPrefix(VoidLightningOrb_JustMoreDamage);
    ...
    {
        if (SS2Content.Items.PortableReactor == null)
        {
            return;
        }
    ...
    private static float GetErraticGadgetDamageMult(GameObject attacker)
    {
        ...
        if (ConfigOptions.ItemChanges.ErraticGadget.Value == ConfigOptions.ItemChanges.ErraticGadgetEditType.DamageMultAndOnHitProc)
        {
            return 2;
        }
        else if (ConfigOptions.ItemChanges.ErraticGadget.Value == ConfigOptions.ItemChanges.ErraticGadgetEditType.OnlyDamageMult)
        {
